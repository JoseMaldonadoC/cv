...
class App extends React.Component {
  ...
  loadData(pathData) {
    $.ajax({
      ...
      success: function (data) {
        this.setState({ joseResumeData: data });
      }.bind(this),
  ...
  render() {
    ...
    return (
      <div className="App">
        <Header data={this.state.joseResumeData}></Header>
        <About data={this.state.joseResumeData}></About>
        <Education data={this.state.joseResumeData}></Education>
        <Portfolio data={this.state.joseResumeData}></Portfolio>
